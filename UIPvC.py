...
pygame.display.set_caption("Simple Pygame Chess (PvC)")
...
def draw_menu(surface):
    ...
    button_texts = ["Player vs Computer"]
    button_rects = []
    button_height = 60
    button_width = 350
    ...
    for event in pygame.event.get():
        ...
        if game_state == "MENU":
            ...
            if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:  # Click chuột trái
                ...
                is_player_interaction_allowed = (game_mode == "PVC" and board.turn != computer_color)
