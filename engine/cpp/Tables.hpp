 ...
 namespace Tables
 {
     ...
     extern U64 FRONT_SPANS[2][SQUARE_NB]; 
     extern U64 PAWN_ATTACK_SPANS[2][SQUARE_NB]; 
     extern U64 PASSED_PAWN_MASK[2][SQUARE_NB]; 
     extern U64 ATTACK_TABLE[Piece::PIECE_TYPE_NB][SQUARE_NB];
     extern U64 PAWN_ATTACK_TABLE[Color::COLOR_NB][SQUARE_NB];
