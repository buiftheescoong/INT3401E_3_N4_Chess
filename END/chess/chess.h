...
namespace chess
{
    inline std::string __author__ = "Patrick Johnson";

    inline std::string __email__ = "pjpuzzler@gmail.com";

    inline std::string __version__ = "1.0.0";
...
const Bitboard BB_FILE_A = 0x0101010101010101ULL << 0;
const Bitboard BB_FILE_B = 0x0101010101010101ULL << 1;
const Bitboard BB_FILE_C = 0x0101010101010101ULL << 2;
const Bitboard BB_FILE_D = 0x0101010101010101ULL << 3;
const Bitboard BB_FILE_E = 0x0101010101010101ULL << 4;
const Bitboard BB_FILE_F = 0x0101010101010101ULL << 5;
const Bitboard BB_FILE_G = 0x0101010101010101ULL << 6;
const Bitboard BB_FILE_H = 0x0101010101010101ULL << 7;
...
{
    int operator()(const chess::Piece &piece) const noexcept {
